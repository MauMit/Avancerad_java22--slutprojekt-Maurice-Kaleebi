...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		addWorkerButton.setBackground(Color.GREEN);
		removeWorkerButton = new JButton("-");
		removeWorkerButton.setBackground(Color.RED);
		saveLogButton = new JButton("Save To Log");
	...
	public void printTotalProducers(int totalProducers) {
		logArea.append("Active producers " + totalProducers + "\n");
	}
